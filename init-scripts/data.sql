...
create table expectations (id bigint not null auto_increment, amount float(53), category_id bigint not null, user_id bigint not null, primary key (id)) engine=InnoDB;
